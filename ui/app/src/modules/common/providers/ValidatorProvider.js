...
angular.module('common').provider('$validation', function() {
    ...
    this.validate = function(form) {
        ...
        if (form.validationId) { // single
            ...
            for (var i in form) { // whole scope
                if (i[0] !== '$' && !_.isEmpty(form[i]) && form[i].hasOwnProperty('$dirty')) {
    ...
    this.reset = function(form) {
        ...
        if (form.validationId) {
            ...
            for (var i in form) {
                if (i[0] !== '$' && !_.isUndefined(form[i]) && form[i].hasOwnProperty('$dirty')) {
