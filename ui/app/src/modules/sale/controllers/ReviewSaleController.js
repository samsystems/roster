...
angular.module('sale').controller('ReviewSaleController', ['$scope', '$rootScope', '$stateParams', 'config', 'DateTimeService', 'Note', 'ProjectService', '$validation', 'toaster', '$upload', 'DocumentService', function ($scope, $rootScope, $stateParams, config, DateTimeService, Note, ProjectService, $validation, toaster, $upload, DocumentService) {
